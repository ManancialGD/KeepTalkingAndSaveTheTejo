...
public class BuildTools6
{
    private static string buildsPath = "Builds";
    private static string windowsBuildPath = Path.Combine(buildsPath, "Windows");
    private static string gameName = "KeepTalkingAndSaveTheTejo";
    private static string exeName = gameName + ".exe";
    private static string windowsGamePath = Path.Combine(windowsBuildPath, exeName);
